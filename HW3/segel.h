...
#define DROP_TAIL 1
#define DROP_HEAD 2
#define BLOCK_FLUSH 3
#define DYNAMIC 4
#define RANDOM 5

typedef struct my_queue_Node my_queue_Node;
typedef struct my_queue my_queue;
my_queue_Node* my_queue_node_init(int fd, struct timeval* curr);
my_queue* my_queue_init();

typedef struct my_pool_thread my_pool_thread;
typedef struct my_pool my_pool;

my_pool_thread* my_pool_thread_init(int id);
